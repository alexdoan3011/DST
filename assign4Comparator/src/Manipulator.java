...
class Manipulator {
    ...
    static boolean addAndSearchContact(Scanner scanner, boolean IO, boolean searchMode) {
        ...
        DataNode node = new DataNode(tmp[0], phoneNumberNormalizer(tmp[1]));// create a new DataNode with normalized phone number
        if (searchMode) {
    ...
    static void displayResponsibilities() {
        ...
        System.out.println(dataStructure.responsibilities());
    }
     ...
     */
    private static String phoneNumberNormalizer(String phoneNumber) {
